...
test_dataset = './segmentation/LViT/datasets/' + task_name + '/Test_Folder/'
# task_dataset = './datasets/' + task_name + '/Train_Folder/'
session_name = 'Test_session' + '_' + 'MoNuSeg_lvit'
...
test_session = "Test_session_MoNuSeg_lvit"  # dice=79.98, IoU=66.83